...
class PersegiPanjang(Bentuk):
    def __init__(self, panjang, lebar, warna):   # ← warna ditambahkan
        self.panjang = panjang
        self.lebar = lebar
        self.warna = warna                     # ← simpan warna
...
# ← PersegiPanjang sekarang butuh warna
...
print(f"Warna Persegi Panjang: {p.warna}")     # ← tampilkan warna
